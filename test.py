...
st2 = '<body><div class="container"><div class="container d-flex flex-wrap"><ul class="nav me-auto align-items-center mt-2"><img src="img/ict_tran.png" height="60" width="60"><a class="navbar-brand ms-3 " href="Homepage/homepage.html">ระบบฐานข้อมูลและการคาดการ์ปริมาณน้ำกว๊านพะเยา</a></ul><ul class="nav mt-3"><li class="nav-item"><a href="Homepage/homepage.html" class="nav-link link-dark px-2 active" aria-current="page">หน้าแรก</a></li><li class="nav-item"><a href="Contract/contract.html" class="nav-link link-dark px-2">ติดต่อ</a></li><li class="nav-item"><a href="About/about.html" class="nav-link link-dark px-2">เกี่ยวกับเรา</a></li><li class="nav-item"><a href="login.php" class="nav-link link-dark px-2">สำหรับแอดมิน</a></li></ul></div></nav>'
st3 = ' <div class="row"><script src="https://cdn.jsdelivr.net/npm/chart.js"></script><script src="https://cdn.jsdelivr.net/npm/chart.js"></script><main class="my-4"> <div class="col-xl-12"><div class="mb-4"><h4 class="text-center">กราฟแสดงข้อมูลการเปรียบเทียบปริมาณน้ำและปริมาณน้ำที่คาดการณ์</h4><img src="img/graphforecast.png" height="80%" width="80%" class="mx-auto d-block"></div></div><div class="col-xl-12"><div class="mb-4"><h4 class="text-center">กราฟแสดงปริมาณน้ำตลอด 1 ปี</h4><img src="img/components_year.png" height="80%" width="80%" class="mx-auto d-block"></div></div></main></div></div>'
